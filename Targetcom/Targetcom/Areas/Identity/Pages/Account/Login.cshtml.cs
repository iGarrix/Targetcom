            ...
            if (ModelState.IsValid)
            {
                ...
                try
                {
                    ...
                    if (ban is not null)
                    {
                        if (ban.IsPermanent)
                        {
                            ModelState.AddModelError(string.Empty, $"This account is always non-active. Profile sets permanent banned");
                            return Page();
                        }
                        else
                        {
                            ...
                            {
                                ModelState.AddModelError(string.Empty, $"This user is banned. Reason end date/time: {ban.ReasonDate.ToString("dd/MM/yyyy - HH:mm")}");
                                return Page();
                            }
                        }
                ...
                {
                    ModelState.AddModelError(string.Empty, "Invalid login attempt. Write to help");
                    return Page();
                }
            }
